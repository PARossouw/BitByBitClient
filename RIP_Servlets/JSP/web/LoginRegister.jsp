        ...
        <section class="header" background-img src="images/storyOfTheDay.jpg">
            <nav>
                <ul class="clearfix">
                    ...
                    <li>
                         <button type="button">LoginRegister</button>
                    </li>
                </ul>
            ...
            <div class="h_div">
                ...
                <input type="text" class="form" placeholder="Password"><!-- comment -->
                <input type="text" class="form" placeholder="Username">
                <h5 style="color:black">Written by : Micheal Jordon</h5>
                <h5 style="color:black">Rating 4.7/5</h5>
...
Jordan's individual accolades and accomplishments include six NBA Finals Most Valuable Player (MVP) awards, ten NBA scoring titles (both all-time records), five NBA MVP awards, ten All-NBA First Team designations, nine All-Defensive First Team honors, fourteen NBA All-Star Game selections, three NBA All-Star Game MVP awards, three NBA steals titles, and the 1988 NBA Defensive Player of the Year Award.[13] He holds the NBA records for career regular season scoring average (30.12 points per game) and career playoff scoring average (33.45 points per game). In 1999, he was named the 20th century's greatest North American athlete by ESPN, and was second to Babe Ruth on the Associated Press' list of athletes of the century.[5] Jordan was twice inducted into the Naismith Memorial Basketball Hall of Fame, once in 2009 for his individual career,[16] and again in 2010 as part of the 1992 United States men's Olympic basketball team ("The Dream Team").[17] He became a member of the United States Olympic Hall of Fame in 2009,[18] a member of the North Carolina Sports Hall of Fame in 2010,[19] and an individual member of the FIBA Hall of Fame in 2015 and a "Dream Team" member in 2017.[20][21] In 2021, Jordan was named to the NBA 75th Anniversary Team.[22]
