...
<%
        ...
        HashMap <String, Integer> writersMap = (HashMap<String, Integer>)request.getAttribute("rejectedWritersMap");
...
<html>
    ...
    <body>
        ...
        <h4>Top 5 Highest Rejected Writers for the Current Month</h4>

        <form action="UserServlet" method="get">

            <input class="button1" name="submit" type="submit" value="Top 5 Writers">
        </form>
